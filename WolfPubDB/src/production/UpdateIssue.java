...
public class UpdateIssue {
	...
	public static void execute(String columnName, int updateID, String updatedValue) {
        String sql = String.format("UPDATE Periodical SET %s='%s' WHERE PublicationID = %d;",columnName,updatedValue,updateID);
        System.out.println("sql::" + sql);
		WolfPubDB.executeUpdate(sql);
	}

   public static void showDistributorDetails(){
        String sql = String.format("SELECT * FROM Periodical;");
        System.out.println("sql::" + sql);
	...
	public static void main(String[] args) {
		System.out.println("\n");
		System.out.println("Update issue data");
        ...
        for(int i = 0;i <numberOfColums;i++){
            ...
            System.out.println("Enter the publication ID of the issue you want to update");
